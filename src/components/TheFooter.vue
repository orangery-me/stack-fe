		...
		<div class="container-center">
			<div class="footer-content">
				...
				<div class="footer-brand">
					...
					<p class="footer-description">
						Building the future with cutting-edge technology and innovative design.
					</p>
				...
				<div class="footer-links">
					<nav class="footer-nav">
						<h6 class="footer-nav-title">Product</h6>
					...
					<nav class="footer-nav">
						<h6 class="footer-nav-title">Legal</h6>
			...
			<div class="footer-bottom">
				<p class="footer-copyright">
					&copy; {{ new Date().getFullYear() }} Starfield. All rights reserved.
				</p>
			</div>
		</div>
	</footer>
...
.footer-brand {
	...
	.social-link {
		...
		&:hover {
			border-color: #B8A7FF;
			color: #B8A7FF;
			box-shadow: 0 0 15px rgba(184, 167, 255, 0.4);
...
.footer-bottom {
	border-top: 1px solid rgba(184, 167, 255, 0.1);
	padding-top: 2rem;
	text-align: center;
